...
public class ShoutsPresenterTest {
    ...
    public void setUp() {
        ...
        mBehaviorSubject = BehaviorSubject.create(ResponseOrError.fromData(new ShoutsResponse(0, "", "", ImmutableList.of(new Shout("", "", "", "", new UserLocation(0, 0, "", "", "", "", ""), "", "", 0, 0, "", "", "", null, null, null, 0, null, null, 0)))));
