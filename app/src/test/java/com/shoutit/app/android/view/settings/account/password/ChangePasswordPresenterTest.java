...
public class ChangePasswordPresenterTest {
    ...
    public void setUp() throws Exception {
        ...
        when(userPreferences.getUserObservable())
                .thenReturn(Observable.just(new User("", null, null, null, null, null, null, null, false, null, null, true, false, null, 1, null)));
    ...
    private User userWithPasswordSet() {
        return new User("", null, null, null, null, null, null, null, false, null, null, false, false, null, 1, null);
    }
}
