...
public class TestUtils {
    ...
    public static User getUser() {
        return new User("id", null, null, null, "userrname", null, null, null,
                ...
                null, 1, null, false, null, null, null, null, null, null, null, null, null, null);
    }

    public static Shout getShout() {
        return new Shout("", "", "", "", new UserLocation(
                0, 0, "", "", "", "", ""), "", "", 0L, 0, "", "", "", getUser(),
                null, null, 0,false, null, null, 0, ImmutableList.<ConversationDetails>of(), true, null, null, null, isBookmarked);
    }
