...
public class PageProfilePresenter implements ProfilePresenter {
    ...
    public PageProfilePresenter(@Nonnull String username,
        ...
        final Observable<ResponseOrError<Page>> userRequestObservable = profilesDao.getProfileObservable(userName)
                .compose(ResponseOrError.map(new Func1<BaseProfile, Page>() {
                    @Override
                    public Page call(BaseProfile baseProfile) {
                        return (Page) baseProfile;
                    }
                }))
                .observeOn(uiScheduler)
                .compose(ObservableExtensions.<ResponseOrError<Page>>behaviorRefCount());
        ...
        shareObservable = shareInitSubject
                .withLatestFrom(userSuccessObservable, (o, user) -> "");
    ...
    private Func4<Page, List<BaseAdapterItem>, List<BaseProfile>, List<BaseProfile>, List<BaseAdapterItem>> combineAdapterItems() {
