...
public class RegisterUtils {
    ...
    public static void setUpSpans(@NonNull Context context, TextView bottomTextView) {
        ...
        final SpannableString spannableString = SpanUtils.clickableColoredUnderlinedSpan(bottomText, textTermsOfService, () -> context.startActivity(HtmlAssetViewerActivity.newIntent(
                context, AssetsConstants.ASSET_TERMS_OF_SERVICE,
                context.getString(R.string.html_activity_terms))));

        final SpannableString finalSpannableString = SpanUtils.clickableColoredUnderlinedSpan(spannableString, textPrivacyPolicy, () -> context.startActivity(HtmlAssetViewerActivity.newIntent(
                context, AssetsConstants.ASSET_TERMS_OF_SERVICE,
