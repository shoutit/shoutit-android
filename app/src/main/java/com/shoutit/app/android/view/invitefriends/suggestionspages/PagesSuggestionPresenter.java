...
public class PagesSuggestionPresenter extends ProfilesListPresenter {

    private final Observable<Object> loadMoreObservable;
    private final Observable<ProfilesDao.PagesSuggestionDao> listeningObservable;
    private final Observable<List<BaseAdapterItem>> usersObservable;
    private final Observable<Boolean> progressObservable;
    private final Observable<Throwable> errorObservable;
    private final Observable<ProfilesDao.PagesSuggestionDao> daoObservable;
    ...
    public Observable<ProfilesDao.PagesSuggestionDao> getListeningObservable() {
