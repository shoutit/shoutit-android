...
public class SentLocationMessage implements BaseAdapterItem {
    ...
    public boolean equals(Object o) {
        ...
        final SentLocationMessage that = (SentLocationMessage) o;
    ...
    public boolean matches(@Nonnull BaseAdapterItem item) {
        return item instanceof SentLocationMessage && time.equals(((SentLocationMessage) item).time);
    }

    @Override
    public boolean same(@Nonnull BaseAdapterItem item) {
        return item instanceof SentLocationMessage && this.equals(item);
    }
