...
public abstract class ClassSubscriptionViewHolderManager<T extends BaseAdapterItem> implements ViewHolderManager {

    public abstract class ViewBinder {

        public abstract Subscription bind(T t);
    }

    private final Class<T> clazz;
    private final int mLayoutRes;

    public ClassSubscriptionViewHolderManager(Class<T> clazz, @LayoutRes int layoutRes) {
        this.clazz = clazz;
    ...
    private class ViewHolder extends BaseViewHolder<T> {
        ...
        public void bind(@Nonnull T t) {
            unsubscribe();
            subscription = mViewBinder.bind(t);
        }
