 ...
 */
package com.shoutit.app.android.retainfragment;
...
public class RetainFragmentHelper {
    ...
    public static <T> T getObjectOrNull(@NonNull Object tag,
        ...
        final String tag1 = getTag(tag);
        final RetainFragment<T> instance = RetainFragmentHelper.getInstance(fragmentManager, tag1);
    ...
    public static <T> void setObject(@NonNull Object tag,
                                     ...
                                     @NonNull T object) {
        final String tag1 = getTag(tag);
        RetainFragment<T> instance = getInstance(fragmentManager, tag1);
        if (instance == null) {
